...
MEDIA_BUNDLES = (
    ...
    ('calendar.calendar.css',
        'css/frontierCalendar/jquery-frontier-cal-1.3.2.css',
    ),
    ('calendar.colorpicker.css',
        'css/colorpicker/colorpicker.css',
    ),
    ('calendar.smoothness.css',
        'css/jquery-ui/smoothness/jquery-ui-1.8.1.custom.css',
    ),
    ('calendar.jquery.core.js',
        'js/jquerycore/jquery-1.4.2-ie-fix.min.js',
    ),
    ('calendar.jquery.ui.js',
        'js/jqueryui/smoothness/jquery-ui-1.8.1.custom.min.js',
    ),
    ('calendar.qtip.js',
        'js/jquery-qtip-1.0.0-rc3140944/jquery.qtip-1.0.js',
    ),
    ('calendar.colorpicker.js',
        'js/colorpicker/colorpicker.js',
    ),
    ('calendar.jshashtable.js',
        'js/lib/jshashtable-2.1.js',
    ),
    ('calendar.js',
        'js/frontierCalendar/jquery-frontier-cal-1.3.2.min.js',
    ),
)
