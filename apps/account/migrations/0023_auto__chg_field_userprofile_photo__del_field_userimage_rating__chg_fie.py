...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('account_userprofile', 'photo', self.gf('images.fields.ImageWithThumbField')(max_length=100))
        # Deleting field 'UserImage.rating'
        db.delete_column('account_userimage', 'rating')


        # Changing field 'UserImage.image'
        db.alter_column('account_userimage', 'image', self.gf('images.fields.ImageWithThumbField')(max_length=100))
    ...
    models = {
        ...
        'account.userprofile': {
            ...
            'photo': ('images.fields.ImageWithThumbField', [], {'default': "'images/noProfilePhoto.png'", 'max_length': '100'}),
