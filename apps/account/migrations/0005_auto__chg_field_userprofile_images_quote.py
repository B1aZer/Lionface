...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.images_quote'
        db.alter_column('account_userprofile', 'images_quote', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'UserProfile.images_quote'
        db.alter_column('account_userprofile', 'images_quote', self.gf('django.db.models.fields.CharField')(max_length=70))
