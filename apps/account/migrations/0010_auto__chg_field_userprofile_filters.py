...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.filters'
        db.alter_column('account_userprofile', 'filters', self.gf('django.db.models.fields.CharField')(max_length='1'))
    ...
    models = {
        ...
        'account.userprofile': {
            ...
            'filters': ('django.db.models.fields.CharField', [], {'default': "'A'", 'max_length': "'10'"}),
