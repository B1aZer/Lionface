...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.bio_text'
        db.add_column('account_userprofile', 'bio_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.bio_text'
        db.delete_column('account_userprofile', 'bio_text')
