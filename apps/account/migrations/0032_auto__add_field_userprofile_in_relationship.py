...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.in_relationship'
        db.add_column('account_userprofile', 'in_relationship',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['account.UserProfile'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field in_relationship on 'UserProfile'
        db.delete_table('account_userprofile_in_relationship')


    def backwards(self, orm):
        # Deleting field 'UserProfile.in_relationship'
        db.delete_column('account_userprofile', 'in_relationship_id')

        # Adding M2M table for field in_relationship on 'UserProfile'
        db.create_table('account_userprofile_in_relationship', (
        ...
        db.create_unique('account_userprofile_in_relationship', ['from_userprofile_id', 'to_userprofile_id'])
