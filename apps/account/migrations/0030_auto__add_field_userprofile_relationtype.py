...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.relationtype'
        db.add_column('account_userprofile', 'relationtype',
    ...
    def backwards(self, orm):
        # Deleting field 'UserProfile.relationtype'
        db.delete_column('account_userprofile', 'relationtype')
