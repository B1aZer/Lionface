...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('account_userprofile', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(default='static/images/noProfilePhoto.png', max_length=100),
                      keep_default=False)
    ...
    models = {
        ...
        'account.userprofile': {
            ...
            'photo': ('django.db.models.fields.files.ImageField', [], {'default': "'static/images/noProfilePhoto.png'", 'max_length': '100'}),
