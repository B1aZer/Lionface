...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserOptions.name'
        db.alter_column('account_useroptions', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'UserOptions.value'
        db.alter_column('account_useroptions', 'value', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'RelationRequest.type'
        db.alter_column('account_relationrequest', 'type', self.gf('django.db.models.fields.TextField')(max_length=1))

        # Changing field 'UserProfile.relationtype'
        db.alter_column('account_userprofile', 'relationtype', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'UserProfile.filters'
        db.alter_column('account_userprofile', 'filters', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'UserProfile.timezone'
        db.alter_column('account_userprofile', 'timezone', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'UserProfile.optional_name'
        db.alter_column('account_userprofile', 'optional_name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Relationship.status'
        db.alter_column('account_relationship', 'status', self.gf('django.db.models.fields.CharField')(max_length=1))
