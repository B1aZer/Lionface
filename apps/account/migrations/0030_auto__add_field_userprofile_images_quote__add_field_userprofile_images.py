...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.images_quote'
        db.add_column('account_userprofile', 'images_quote',
                      self.gf('django.db.models.fields.CharField')(default='Whose woods these are I think I know, his house is in the village though.', max_length=70),
                      keep_default=False)

        # Adding field 'UserProfile.images_quote_author'
        db.add_column('account_userprofile', 'images_quote_author',
                      self.gf('django.db.models.fields.CharField')(default='Robert Frost', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.images_quote'
        db.delete_column('account_userprofile', 'images_quote')

        # Deleting field 'UserProfile.images_quote_author'
        db.delete_column('account_userprofile', 'images_quote_author')
