...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.filters'
        db.add_column('account_userprofile', 'filters',
                      self.gf('django.db.models.fields.CharField')(default='P', max_length='1'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.filters'
        db.delete_column('account_userprofile', 'filters')
    ...
    models = {
        ...
        'account.userprofile': {
            ...
            'filters': ('django.db.models.fields.CharField', [], {'default': "'P'", 'max_length': "'1'"}),
