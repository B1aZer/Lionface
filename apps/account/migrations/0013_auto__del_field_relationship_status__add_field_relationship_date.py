...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Relationship.status'
        db.delete_column('account_relationship', 'status')

        # Adding field 'Relationship.date'
        db.add_column('account_relationship', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 9, 18, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Relationship.status'
        db.add_column('account_relationship', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Relationship.date'
        db.delete_column('account_relationship', 'date')
    ...
    models = {
        ...
        'account.userprofile': {
            ...
            'related_to': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'rel+'", 'symmetrical': 'False', 'through': "orm['account.Relationship']", 'to': "orm['account.UserProfile']"}),
