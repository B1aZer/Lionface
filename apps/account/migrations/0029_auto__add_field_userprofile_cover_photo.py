...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.cover_photo'
        db.add_column('account_userprofile', 'cover_photo',
                      self.gf('django.db.models.fields.files.ImageField')(default='uploads/images/bg_cover.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.cover_photo'
        db.delete_column('account_userprofile', 'cover_photo')
