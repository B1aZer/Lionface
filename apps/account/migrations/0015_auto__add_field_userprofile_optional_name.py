...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.optional_name'
        db.add_column('account_userprofile', 'optional_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length='200'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.optional_name'
        db.delete_column('account_userprofile', 'optional_name')
