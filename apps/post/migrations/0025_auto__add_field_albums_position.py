...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Albums.position'
        db.add_column('post_albums', 'position',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Albums.position'
        db.delete_column('post_albums', 'position')
    ...
    models = {
        ...
        'post.post': {
            ...
            'album': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'posts'", 'null': 'True', 'to': "orm['post.Albums']"}),
