...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContentPost.content'
        db.alter_column('post_contentpost', 'content', self.gf('django.db.models.fields.CharField')(max_length=5000))

    def backwards(self, orm):

        # Changing field 'ContentPost.content'
        db.alter_column('post_contentpost', 'content', self.gf('django.db.models.fields.TextField')())
