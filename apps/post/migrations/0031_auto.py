...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field voted on 'FeedbackPost'
        db.create_table('post_feedbackpost_voted', (
        ...
        db.create_unique('post_feedbackpost_voted', ['feedbackpost_id', 'userprofile_id'])


    def backwards(self, orm):
        # Removing M2M table for field voted on 'FeedbackPost'
        db.delete_table('post_feedbackpost_voted')
    ...
    models = {
        ...
        'post.feedbackpost': {
            ...
            'content': ('django.db.models.fields.CharField', [], {'max_length': '5000'}),
            'disagrees': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'feedback_posts'", 'to': "orm['pages.Pages']"}),
            'post_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['post.Post']", 'unique': 'True', 'primary_key': 'True'}),
            'rating': ('django.db.models.fields.IntegerField', [], {}),
            'voted': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'feedback_votes'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['account.UserProfile']"})
        },
        'post.friendpost': {
