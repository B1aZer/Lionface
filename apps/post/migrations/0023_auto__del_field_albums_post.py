...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Albums.post'
        db.delete_column('post_albums', 'post_id')

        # Adding M2M table for field posts on 'Albums'
        db.create_table('post_albums_posts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('albums', models.ForeignKey(orm['post.albums'], null=False)),
            ('post', models.ForeignKey(orm['post.post'], null=False))
        ))
        db.create_unique('post_albums_posts', ['albums_id', 'post_id'])


    def backwards(self, orm):
        # Adding field 'Albums.post'
        db.add_column('post_albums', 'post',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['post.Post']),
                      keep_default=False)

        # Removing M2M table for field posts on 'Albums'
        db.delete_table('post_albums_posts')
    ...
    models = {
        ...
        'post.albums': {
            ...
            'posts': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['post.Post']", 'null': 'True', 'blank': 'True'}),
