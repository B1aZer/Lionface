...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SharePost.content_type'
        db.add_column('post_sharepost', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'SharePost.object_id'
        db.add_column('post_sharepost', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SharePost.content_type'
        db.delete_column('post_sharepost', 'content_type_id')

        # Deleting field 'SharePost.object_id'
        db.delete_column('post_sharepost', 'object_id')
