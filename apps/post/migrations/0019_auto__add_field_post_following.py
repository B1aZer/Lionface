...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.following'
        db.add_column('post_post', 'following',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='follows', null=True, to=orm['account.UserProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.following'
        db.delete_column('post_post', 'following_id')
    ...
    models = {
        ...
        'post.post': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'following': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'follows'", 'null': 'True', 'to': "orm['account.UserProfile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
