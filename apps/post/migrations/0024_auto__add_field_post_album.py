...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.album'
        db.add_column('post_post', 'album',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['post.Albums'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Post.album'
        db.delete_column('post_post', 'album_id')
    ...
    models = {
        ...
        'post.post': {
            ...
            'album': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['post.Albums']", 'null': 'True', 'blank': 'True'}),
