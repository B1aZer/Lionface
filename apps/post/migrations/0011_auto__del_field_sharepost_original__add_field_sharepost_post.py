...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SharePost.original'
        db.delete_column('post_sharepost', 'original_id')
    ...
    def backwards(self, orm):
        # Adding field 'SharePost.original'
        db.add_column('post_sharepost', 'original',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['post.Post']),
                      keep_default=False)
