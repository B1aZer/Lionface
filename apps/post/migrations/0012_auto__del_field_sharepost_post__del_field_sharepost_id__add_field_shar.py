...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SharePost.post'
        db.delete_column('post_sharepost', 'post_id')

        # Deleting field 'SharePost.id'
        db.delete_column('post_sharepost', 'id')

        # Adding field 'SharePost.post_ptr'
        db.add_column('post_sharepost', 'post_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['post.Post'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SharePost.post'
        db.add_column('post_sharepost', 'post',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['post.Post']),
                      keep_default=False)

        # Adding field 'SharePost.id'
        db.add_column('post_sharepost', 'id',
                      self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True),
                      keep_default=False)

        # Deleting field 'SharePost.post_ptr'
        db.delete_column('post_sharepost', 'post_ptr_id')
