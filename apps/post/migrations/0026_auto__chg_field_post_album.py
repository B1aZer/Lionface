...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.album'
        db.alter_column('post_post', 'album_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['post.Albums']))

    def backwards(self, orm):

        # Changing field 'Post.album'
        db.alter_column('post_post', 'album_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['post.Albums']))
