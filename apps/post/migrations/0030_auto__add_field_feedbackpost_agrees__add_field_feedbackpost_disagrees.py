...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeedbackPost.agrees'
        db.add_column('post_feedbackpost', 'agrees',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'FeedbackPost.disagrees'
        db.add_column('post_feedbackpost', 'disagrees',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeedbackPost.agrees'
        db.delete_column('post_feedbackpost', 'agrees')

        # Deleting field 'FeedbackPost.disagrees'
        db.delete_column('post_feedbackpost', 'disagrees')
