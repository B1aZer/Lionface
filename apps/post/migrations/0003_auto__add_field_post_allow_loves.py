...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.allow_loves'
        db.add_column('post_post', 'allow_loves',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.allow_loves'
        db.delete_column('post_post', 'allow_loves')
    ...
    models = {
        ...
        'post.post': {
            ...
            'allow_loves': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
