...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.user_to'
        db.add_column('post_post', 'user_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='user_to', to=orm['account.UserProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.user_to'
        db.delete_column('post_post', 'user_to_id')
