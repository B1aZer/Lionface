...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.allow_commenting'
        db.add_column('post_post', 'allow_commenting',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Post.allow_sharing'
        db.add_column('post_post', 'allow_sharing',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.allow_commenting'
        db.delete_column('post_post', 'allow_commenting')

        # Deleting field 'Post.allow_sharing'
        db.delete_column('post_post', 'allow_sharing')
