...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.user_to'
        db.alter_column('post_post', 'user_to_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.UserProfile']))

    def backwards(self, orm):

        # Changing field 'Post.user_to'
        db.alter_column('post_post', 'user_to_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['account.UserProfile']))
