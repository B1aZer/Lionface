...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageSharePost.id_news'
        db.add_column('post_pagesharepost', 'id_news',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageSharePost.id_news'
        db.delete_column('post_pagesharepost', 'id_news')
