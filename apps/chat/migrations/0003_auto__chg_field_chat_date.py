...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Chat.date'
        db.alter_column('chat_chat', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Chat.date'
        db.alter_column('chat_chat', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'chat.chat': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tabs_to': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
