...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chat.chat_list'
        db.add_column('chat_chat', 'chat_list',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Chat.chat_list'
        db.delete_column('chat_chat', 'chat_list')
    ...
    models = {
        ...
        'chat.chat': {
            ...
            'chat_list': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
