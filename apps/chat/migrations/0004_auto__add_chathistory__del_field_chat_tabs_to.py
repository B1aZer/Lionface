...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChatHistory'
        db.create_table('chat_chathistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='chat_history', to=orm['account.UserProfile'])),
            ('tab_from', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tab_from', to=orm['chat.Chat'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('opened', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('chat', ['ChatHistory'])

        # Deleting field 'Chat.tabs_to'
        db.delete_column('chat_chat', 'tabs_to')


    def backwards(self, orm):
        # Deleting model 'ChatHistory'
        db.delete_table('chat_chathistory')

        # Adding field 'Chat.tabs_to'
        db.add_column('chat_chat', 'tabs_to',
    ...
    models = {
        ...
        'chat.chat': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tabs_to': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'chat_tabs'", 'symmetrical': 'False', 'through': "orm['chat.ChatHistory']", 'to': "orm['account.UserProfile']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['account.UserProfile']"})
        },
        'chat.chathistory': {
            'Meta': {'object_name': 'ChatHistory'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'from_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'chat_history'", 'to': "orm['account.UserProfile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'opened': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'tab_from': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tab_from'", 'to': "orm['chat.Chat']"})
        },
