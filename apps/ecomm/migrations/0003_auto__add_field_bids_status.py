...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bids.status'
        db.add_column('ecomm_bids', 'status',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length='1'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bids.status'
        db.delete_column('ecomm_bids', 'status')
    ...
    models = {
        ...
        'ecomm.customers': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'customer'", 'to': "orm['account.UserProfile']"})
        },
        'pages.membership': {
