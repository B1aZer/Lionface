...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customers.page'
        db.add_column('ecomm_customers', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='customer', null=True, to=orm['pages.Pages']),
                      keep_default=False)


        # Changing field 'Customers.user'
        db.alter_column('ecomm_customers', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.UserProfile']))

    def backwards(self, orm):
        # Deleting field 'Customers.page'
        db.delete_column('ecomm_customers', 'page_id')


        # Changing field 'Customers.user'
        db.alter_column('ecomm_customers', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['account.UserProfile']))
