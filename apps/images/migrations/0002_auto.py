...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field following on 'Image'
        db.create_table('images_image_following', (
        ...
        db.create_unique('images_image_following', ['image_id', 'userprofile_id'])


    def backwards(self, orm):
        # Removing M2M table for field following on 'Image'
        db.delete_table('images_image_following')
