...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PageRequest.from_event'
        db.delete_column('pages_pagerequest', 'from_event_id')

        # Adding field 'PageRequest.event'
        db.add_column('pages_pagerequest', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='from_event', null=True, to=orm['agenda.Events']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PageRequest.from_event'
        db.add_column('pages_pagerequest', 'from_event',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='from_event', null=True, to=orm['agenda.Events'], blank=True),
                      keep_default=False)

        # Deleting field 'PageRequest.event'
        db.delete_column('pages_pagerequest', 'event_id')
