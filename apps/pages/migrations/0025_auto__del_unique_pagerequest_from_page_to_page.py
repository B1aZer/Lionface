...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PageRequest', fields ['from_page', 'to_page']
        db.delete_unique('pages_pagerequest', ['from_page_id', 'to_page_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'PageRequest', fields ['from_page', 'to_page']
        db.create_unique('pages_pagerequest', ['from_page_id', 'to_page_id'])
