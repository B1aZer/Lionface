...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.is_present'
        db.add_column('pages_membership', 'is_present',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Membership.to_date'
        db.alter_column('pages_membership', 'to_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Membership.is_present'
        db.delete_column('pages_membership', 'is_present')


        # Changing field 'Membership.to_date'
        db.alter_column('pages_membership', 'to_date', self.gf('django.db.models.fields.DateField')())
