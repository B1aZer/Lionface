...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pages.url'
        db.add_column('pages_pages', 'url',
                      self.gf('django.db.models.fields.CharField')(max_length='2000', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Pages.content'
        db.add_column('pages_pages', 'content',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pages.url'
        db.delete_column('pages_pages', 'url')

        # Deleting field 'Pages.content'
        db.delete_column('pages_pages', 'content')
