...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageRequest.type'
        db.add_column('pages_pagerequest', 'type',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PageRequest.type'
        db.delete_column('pages_pagerequest', 'type')
    ...
    models = {
        ...
        'pages.pagerequest': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'from_event': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'from_event'", 'null': 'True', 'to': "orm['agenda.Events']"}),
