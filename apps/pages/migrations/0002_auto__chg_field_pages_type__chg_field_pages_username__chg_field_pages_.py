...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pages.type'
        db.alter_column('pages_pages', 'type', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'Pages.username'
        db.alter_column('pages_pages', 'username', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200))

        # Changing field 'Pages.name'
        db.alter_column('pages_pages', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Pages.url'
        db.alter_column('pages_pages', 'url', self.gf('django.db.models.fields.URLField')(max_length=2000, null=True))

        # Changing field 'PageRequest.type'
        db.alter_column('pages_pagerequest', 'type', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'Membership.type'
        db.alter_column('pages_membership', 'type', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'PageLoves.status'
        db.alter_column('pages_pageloves', 'status', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Topics.name'
        db.alter_column('pages_topics', 'name', self.gf('django.db.models.fields.CharField')(max_length=2000))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Pages.username'
        db.alter_column('pages_pages', 'username', self.gf('django.db.models.fields.CharField')(max_length='200', unique=True))
