...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pages.photo'
        db.add_column('pages_pages', 'photo',
                      self.gf('images.fields.ImageWithThumbField')(default='uploads/images/noProfilePhoto.png', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pages.photo'
        db.delete_column('pages_pages', 'photo')
