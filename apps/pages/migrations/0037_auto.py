...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field users_favourites on 'Pages'
        db.create_table('pages_pages_users_favourites', (
        ...
        db.create_unique('pages_pages_users_favourites', ['pages_id', 'userprofile_id'])


    def backwards(self, orm):
        # Removing M2M table for field users_favourites on 'Pages'
        db.delete_table('pages_pages_users_favourites')
    ...
    models = {
        ...
        'pages.pages': {
            ...
            'users_favourites': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'pages_favourites'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['account.UserProfile']"}),
