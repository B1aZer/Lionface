...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageRequest.is_accepted'
        db.add_column('pages_pagerequest', 'is_accepted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageRequest.is_accepted'
        db.delete_column('pages_pagerequest', 'is_accepted')
