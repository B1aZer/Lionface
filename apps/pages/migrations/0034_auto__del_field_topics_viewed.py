...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Topics.viewed'
        db.delete_column('pages_topics', 'viewed_id')
    ...
    def backwards(self, orm):
        # Adding field 'Topics.viewed'
        db.add_column('pages_topics', 'viewed',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='viewed_topics', null=True, to=orm['account.UserProfile'], blank=True),
                      keep_default=False)
