...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pages_topics', (
            ...
            ('members', self.gf('django.db.models.fields.CharField')(default='A', max_length=1)),
            ('content', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('viewed', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='viewed_topics', null=True, to=orm['account.UserProfile'])),
        ))
    ...
    models = {
        ...
        'pages.topics': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'members': ('django.db.models.fields.CharField', [], {'default': "'A'", 'max_length': '1'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['account.UserProfile']"}),
            'viewed': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'viewed_topics'", 'null': 'True', 'to': "orm['account.UserProfile']"})
        }
    }
