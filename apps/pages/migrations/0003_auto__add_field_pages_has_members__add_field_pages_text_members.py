...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pages.has_members'
        db.add_column('pages_pages', 'has_members',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Pages.text_members'
        db.add_column('pages_pages', 'text_members',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pages.has_members'
        db.delete_column('pages_pages', 'has_members')

        # Deleting field 'Pages.text_members'
        db.delete_column('pages_pages', 'text_members')
