...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field users_loved on 'Pages'
        db.delete_table('pages_pages_users_loved')


    def backwards(self, orm):
        # Adding M2M table for field users_loved on 'Pages'
        db.create_table('pages_pages_users_loved', (
        ...
        db.create_unique('pages_pages_users_loved', ['pages_id', 'userprofile_id'])
