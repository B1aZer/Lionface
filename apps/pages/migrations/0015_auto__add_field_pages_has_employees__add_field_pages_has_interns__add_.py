...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pages.has_employees'
        db.add_column('pages_pages', 'has_employees',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Pages.has_interns'
        db.add_column('pages_pages', 'has_interns',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Pages.has_volunteers'
        db.add_column('pages_pages', 'has_volunteers',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pages.has_employees'
        db.delete_column('pages_pages', 'has_employees')

        # Deleting field 'Pages.has_interns'
        db.delete_column('pages_pages', 'has_interns')

        # Deleting field 'Pages.has_volunteers'
        db.delete_column('pages_pages', 'has_volunteers')
