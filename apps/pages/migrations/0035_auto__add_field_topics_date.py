...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Topics.date'
        db.add_column('pages_topics', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 21, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Topics.date'
        db.delete_column('pages_topics', 'date')
