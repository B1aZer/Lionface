...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pages.text_employees'
        db.add_column('pages_pages', 'text_employees',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Pages.text_interns'
        db.add_column('pages_pages', 'text_interns',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Pages.text_volunteers'
        db.add_column('pages_pages', 'text_volunteers',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pages.text_employees'
        db.delete_column('pages_pages', 'text_employees')

        # Deleting field 'Pages.text_interns'
        db.delete_column('pages_pages', 'text_interns')

        # Deleting field 'Pages.text_volunteers'
        db.delete_column('pages_pages', 'text_volunteers')
