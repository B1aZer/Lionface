...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pages.type'
        db.add_column('pages_pages', 'type',
                      self.gf('django.db.models.fields.CharField')(default='BS', max_length='2'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pages.type'
        db.delete_column('pages_pages', 'type')
