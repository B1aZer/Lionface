...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PageRequest.message'
        db.delete_column('pages_pagerequest', 'message')

        # Adding field 'PageRequest.is_hidden'
        db.add_column('pages_pagerequest', 'is_hidden',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PageRequest.message'
        db.add_column('pages_pagerequest', 'message',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'PageRequest.is_hidden'
        db.delete_column('pages_pagerequest', 'is_hidden')
