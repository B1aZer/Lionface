...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.is_confirmed'
        db.add_column('pages_membership', 'is_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membership.is_confirmed'
        db.delete_column('pages_membership', 'is_confirmed')
