...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Topics.members'
        db.alter_column('pages_topics', 'members', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Topics.members'
        db.alter_column('pages_topics', 'members', self.gf('django.db.models.fields.CharField')(max_length=1))
