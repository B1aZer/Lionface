...
urlpatterns = patterns('',
    ...
    url(r'^business/(?P<slug>\w+)/list_topic/(?P<topic_id>\d+)/$', views.list_topic),
    ...
    url(r'^nonprofit/(?P<slug>\w+)/list_topic/(?P<topic_id>\d+)/$', views.list_topic),
    url(r'^nonprofit_expand/(?P<cat_id>\d+)/$', views.save_browsing_categories_nonp),
