...
class MessageForm(forms.Form):
    ...
    content = forms.CharField(required = True, widget=forms.Textarea(attrs={'style':'width: 100% !important; min-height: 100px !important; -moz-border-radius: 3px; border-radius: 3px; border: 1px solid #DDD; line-height: 1;','cols':'40'}))
