...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Messaging.in_chat'
        db.add_column('messaging_messaging', 'in_chat',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Messaging.in_chat'
        db.delete_column('messaging_messaging', 'in_chat')
    ...
    models = {
        ...
        'messaging.messaging': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'in_chat': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
