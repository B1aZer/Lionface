...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Messaging.content'
        db.alter_column('messaging_messaging', 'content', self.gf('django.db.models.fields.CharField')(max_length=5000))

    def backwards(self, orm):

        # Changing field 'Messaging.content'
        db.alter_column('messaging_messaging', 'content', self.gf('django.db.models.fields.TextField')())
