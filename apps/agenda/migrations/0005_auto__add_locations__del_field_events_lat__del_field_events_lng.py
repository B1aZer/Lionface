...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('agenda_locations', (
            ...
            ('lat', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('lng', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('agenda', ['Locations'])

        # Deleting field 'Events.lat'
        db.delete_column('agenda_events', 'lat')

        # Deleting field 'Events.lng'
        db.delete_column('agenda_events', 'lng')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Events.lat'
        db.add_column('agenda_events', 'lat',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Events.lng'
        db.add_column('agenda_events', 'lng',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'agenda.locations': {
            ...
            'lng': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
