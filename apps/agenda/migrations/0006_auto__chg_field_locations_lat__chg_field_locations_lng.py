...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Locations.lat'
        db.alter_column('agenda_locations', 'lat', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Locations.lng'
        db.alter_column('agenda_locations', 'lng', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Locations.lat'
        db.alter_column('agenda_locations', 'lat', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Locations.lng'
        db.alter_column('agenda_locations', 'lng', self.gf('django.db.models.fields.IntegerField')(null=True))
