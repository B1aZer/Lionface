...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Events.allow_commenting'
        db.add_column('agenda_events', 'allow_commenting',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Events.allow_sharing'
        db.add_column('agenda_events', 'allow_sharing',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Events.allow_commenting'
        db.delete_column('agenda_events', 'allow_commenting')

        # Deleting field 'Events.allow_sharing'
        db.delete_column('agenda_events', 'allow_sharing')
