...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('agenda_events', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Locations.location'
        db.alter_column('agenda_locations', 'location', self.gf('django.db.models.fields.CharField')(max_length=2000))
