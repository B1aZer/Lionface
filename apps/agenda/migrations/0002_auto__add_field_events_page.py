...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Events.page'
        db.add_column('agenda_events', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['pages.Pages']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Events.page'
        db.delete_column('agenda_events', 'page_id')
