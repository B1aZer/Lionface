...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Events.date_end'
        db.add_column('agenda_events', 'date_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Events.description'
        db.add_column('agenda_events', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Events.date_end'
        db.delete_column('agenda_events', 'date_end')

        # Deleting field 'Events.description'
        db.delete_column('agenda_events', 'description')
