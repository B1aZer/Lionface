...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User_Tag.status'
        db.delete_column('tags_user_tag', 'status')

        # Adding field 'User_Tag.active'
        db.add_column('tags_user_tag', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'User_Tag.status'
        db.add_column('tags_user_tag', 'status',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'User_Tag.active'
        db.delete_column('tags_user_tag', 'active')
    ...
    models = {
        ...
        'tags.user_tag': {
            'Meta': {'object_name': 'User_Tag', '_ormbases': ['tags.Tag']},
