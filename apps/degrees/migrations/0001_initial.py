...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Degree'
        db.create_table('degrees_degree', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='degree_from', to=orm['account.UserProfile'])),
            ('to_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='degree_to', to=orm['account.UserProfile'])),
        ...
        db.send_create_signal('degrees', ['Degree'])


    def backwards(self, orm):
        # Deleting model 'Degree'
        db.delete_table('degrees_degree')
    ...
    models = {
        ...
        'degrees.degree': {
            ...
            'from_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'degree_from'", 'to': "orm['account.UserProfile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'path': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'to_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'degree_to'", 'to': "orm['account.UserProfile']"})
        }
    }

    complete_apps = ['degrees']