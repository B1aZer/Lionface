...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('schools_school', (
            ...
            ('city', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('state', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('country', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('approved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user_proposed', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.UserProfile'])),
        ))
