...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'School.user_proposed'
        db.alter_column('schools_school', 'user_proposed_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.UserProfile'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'School.user_proposed'
        raise RuntimeError("Cannot reverse this migration. 'School.user_proposed' and its values cannot be restored.")
    ...
    models = {
        ...
        'schools.school': {
            ...
            'alumni': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['schools.Alum']", 'null': 'True', 'blank': 'True'}),
            ...
            'user_proposed': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['account.UserProfile']", 'null': 'True', 'blank': 'True'}),
