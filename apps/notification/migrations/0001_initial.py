...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notification_notification', (
            ...
            ('friend_request', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.FriendRequest'], blank=True)),
        ))
    ...
    models = {
        ...
        'notification.notification': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'friend_request': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['account.FriendRequest']", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
