...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notification.content_type'
        db.alter_column('notification_notification', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))

        # Changing field 'Notification.object_id'
        db.alter_column('notification_notification', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Notification.content_type'
        db.alter_column('notification_notification', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']))

        # Changing field 'Notification.object_id'
        db.alter_column('notification_notification', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=1))
    ...
    models = {
        ...
        'account.userprofile': {
            ...
            'in_relationship': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'in_relationship_rel_+'", 'to': "orm['account.UserProfile']"}),
