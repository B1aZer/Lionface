...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.related_type'
        db.add_column('notification_notification', 'related_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notification_set2', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Notification.related_id'
        db.add_column('notification_notification', 'related_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.related_type'
        db.delete_column('notification_notification', 'related_type_id')

        # Deleting field 'Notification.related_id'
        db.delete_column('notification_notification', 'related_id')
