...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.people_counter'
        db.add_column('notification_notification', 'people_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.people_counter'
        db.delete_column('notification_notification', 'people_counter')
    ...
    models = {
        ...
        'notification.notification': {
            ...
            'people_counter': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
