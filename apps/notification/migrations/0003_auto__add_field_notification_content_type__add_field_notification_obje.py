...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('notification_notification', 'content_type',
        ...
        db.add_column('notification_notification', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Notification.user'
        db.alter_column('notification_notification', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.UserProfile']))

        # Changing field 'Notification.other_user'
        db.alter_column('notification_notification', 'other_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['account.UserProfile']))

    def backwards(self, orm):
        # Deleting field 'Notification.content_type'
        db.delete_column('notification_notification', 'content_type_id')

        # Deleting field 'Notification.object_id'
        db.delete_column('notification_notification', 'object_id')


        # Changing field 'Notification.user'
        db.alter_column('notification_notification', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Notification.other_user'
        db.alter_column('notification_notification', 'other_user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
